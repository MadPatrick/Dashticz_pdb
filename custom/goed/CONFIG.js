...
blocks['Mower_select'] 		= {idx: 928,  width: 3, hide_data: false, last_update: false,icon: ' ', title: 'Mower R4-D2'}
blocks['Mower_status'] 		= {idx: 924,  width: 1, hide_data: true,  last_update: false,imageOff: 'patrick/husqvarna_off.png',imageOn: 'patrick/husqvarna_on.png',title: ' '}
...
blocks['deursensor'] 		= {idx: 477, width : 3,hide_data : true,icon: ' ',title: 'Deursensoren'}
...
blocks['emptyblock7'] 		= {idx: 923, width : 4,hide_data : true,image: 'patrick/mower.png',title: 'Husqvarna'}
...
blocks['lms_standby'] 		= {idx: 1483, width : 5,iconOff: ' '}
...
columns['home6'] 	= {blocks: ['Party_Mode','Mower_select','Mower_status','lms_play','lms_favorite'], width: 12}
...
columns['test'] 	= {blocks: ['mini','mygarbage_standby','bmw','emptyblock4','emptyblock5','emptyblock6','myclock','weather_standby','regen','deursensor','emptyblock7','lms_standby'], width: 12}
columns['hidden'] 	= {blocks: ['Ketel_druk',buttons.slidehome], width: 4}
...
var columns_standby 		= {}
columns_standby[1] 		= {}
columns_standby[1]['blocks'] 	= ['mini','mygarbage_standby','bmw','emptyblock4','emptyblock5','emptyblock6','myclock','regen','weather_standby','deursensor','emptyblock7','lms_standby']
